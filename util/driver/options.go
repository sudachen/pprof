...
func setDefaults(o *Options) *Options {
	...
	*d = *o
	...
	d.internal.Writer = o.Writer
	d.internal.Fetch = o.Fetch
	d.internal.Flagset = o.Flagset
	d.internal.UI = o.UI

	if o.Writer == nil {
		d.internal.Writer = oswriter{}
	}
	if o.Flagset == nil {
		d.internal.Flagset = goFlags{}
	}

	if o.UI == nil {
		d.internal.UI = &stdUI{r: bufio.NewReader(os.Stdin)}
	}

	d.internal.Obj = &binutils.Binutils{}
	d.internal.Sym = &symbolizer.Symbolizer{Obj: d.internal.Obj, UI: d.internal.UI }
